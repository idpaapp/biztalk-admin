    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          const SizedBox(height: 16.0),
          const Text(
            "انتخاب ساعت" ,style: TextStyle(color: AppColors.lighterBlack,fontSize: 14,fontWeight: FontWeight.w500),
...
class _DialPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint selectorPaint = Paint()..color = AppColors.darkerGreen;
  ...
  Widget build(BuildContext context) {
    ...
    switch (_entryMode.value) {
      ...
      case TimePickerEntryMode.input:
        picker = Form(
          key: _formKey,
          autovalidateMode:!_autoValidate.value? AutovalidateMode.disabled:null ,
...
Future<TimeOfDay?> myShowTimePicker({
