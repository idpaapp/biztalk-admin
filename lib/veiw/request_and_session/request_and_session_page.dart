  ...
  Widget build(BuildContext context) => Scaffold(
        body: Obx(() {
          if (_requestSessionController.failureMessageGetAll.value != "") {
            return Center(
              child: CustomText(
                  title: _requestSessionController.failureMessageGetAll.value),
            );
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ProfileTitleTableWidget(
                    ...
                    sessionDate: data.time == null ?"نا مشخص" :data.time!.sessionTime??"نا مشخص",
                    subject: data.subject == null ? "نا مشخص":data.subject!.title ?? "نا مشخص",
                    state: index == 0
                        ? "red"
                        : index == 1
                            ? "pink"
              ...
              return Obx(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: index + 1 == _requestSessionController.selectedPage.value
